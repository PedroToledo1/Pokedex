...
struct pokedexWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = pokedexWidgetAttributes(name: "Me")
    static let contentState = pokedexWidgetAttributes.ContentState(value: 3)
