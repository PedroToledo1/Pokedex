...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        ...
        if inMemory {
            ...
            container.persistentStoreDescriptions.first!.url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.pedroToledo.pokedex")!.appending(path: "pokedex.sqlite")
        }
